...
const mapUserFromBackend = (backendUser: any): User => {
  ...
  return {
    ...
    role: roleMap[backendUser.roleName] || roleMap[backendUser.role] || 'EMPLOYEE',
    departmentId: backendUser.departmentId || undefined,
    ...
    const initAuth = async () => {
      ...
      if (token) {
        try {
          ...
          setUser(mapUserFromBackend(res.data.data));
        } catch (error) {
